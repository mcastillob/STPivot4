...
import com.stratebi.stpivot4.analytics.state.GeneratedMember;
import com.stratebi.stpivot4.analytics.state.HierarchyFilterItem;
import com.stratebi.stpivot4.analytics.state.HierarchyFiltersMember;
//import com.stratebi.stpivot4.analytics.state.MdxHistory;
import com.stratebi.stpivot4.analytics.state.NameSetMember;
...
public class ViewState extends org.pivot4j.analytics.state.ViewStatePivot4j {
	...
	private void processFormulasInMdx(String mdx, List<CustomMember> auxCustomMembers) throws Throwable {
		...
		for (CustomMember customMember : auxCustomMembers) {
			...
			if (customMember instanceof GeneratedMember) {
				GeneratedMember calculadoraMember = (GeneratedMember)customMember;
	...
	private ModelChangeListener modelChangeListener = new ModelChangeListener() {
		...
		public boolean isValid(PivotModel model) {
